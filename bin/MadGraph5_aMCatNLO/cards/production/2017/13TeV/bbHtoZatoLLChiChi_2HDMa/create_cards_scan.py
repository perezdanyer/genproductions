...
def main():
##############################################
    run_dir = "/nfs/dust/cms/user/perezdan/MC_Production/genproductions/bin/MadGraph5_aMCatNLO/cards/production/2017/13TeV/bbHtoZatoLLChiChi_2HDMa"
    out_dir = "/nfs/dust/cms/user/perezdan/MC_Production/genproductions/bin/MadGraph5_aMCatNLO/cards/production/2017/13TeV/bbHtoZatoLLChiChi_2HDMa/parameter_scan"
    
    dict_param_default = {'frblock 2':10, 'frblock 3':1.0, 'higgs 1':0.25,'higgs 2':0.25,'higgs 3':0.25, 'higgs 5':0.5, 'dminputs 1':1}
    ...
    for MH in ['1400','2000']:
        ...
        for Ma in ['100','400','600','1000','1200','1800']:
            ...
            cust_card = cust_card.replace('herereplacewidthofa', f'Auto')
            cust_card = cust_card.replace('herereplacewidthofH', f'Auto')
            cust_card += f"set param_card MASS 52 45\n"
    ...
    for MH in ['200','400','500','600','800','1000', '1400', '2000']:
