...
card_dir = f"cards/production/2017/13TeV/bbHtoZatoLLChiChi_2HDMa/parameter_scan"
run_dir = f"{work_dir}/HTCondor_run"
output_dir = f"/nfs/dust/cms/user/perezdan/Store/Gridpacks/bbH_Za_LLChiChi/Extension"
