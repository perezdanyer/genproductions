...
card_dir = f"cards/production/2017/13TeV/HToaaTo2mu2c_NMSSM/parameter_scan"
run_dir = f"{work_dir}/HTCondor_run"
output_dir = f"/nfs/dust/cms/user/perezdan/Store/Gridpacks/HToAA/SUSYGluGluToHToAA_AToMuMu_AToCC"
...
####################################################################################
    ...
    file=''
    file+=f'+RequestRuntime       = 5000\n'
    file+=f'RequestMemory         = 1000\n'
